...
const copy: Record<Locale, PageCopy> = {
  en: {
    ...
    demo: {
      ...
      title: '',
      body: '',
      noteKicker: 'Recommended Embed',
      noteBody:
        'Use a short product walkthrough: prompt, discovery result, route preview, then final execution feedback.',
      placeholderLabel: 'Demo video placeholder',
      placeholderHint: 'Replace with your public demo URL',
    },
    differences: {
    ...
    trySection: {
      ...
      cards: [
        {
          title: 'Demo build',
          body: 'Link your current build, test build, or repo instructions here for judges and technical reviewers.',
          action: 'Add demo build link',
          href: '#replace-demo-build-link',
          placeholder: true,
        },
        {
          title: 'Install extension',
          body: 'Point this button to your packaged extension, store listing, or install guide when the asset is ready.',
          action: 'Add install link',
          href: '#replace-install-link',
          placeholder: true,
        },
        {
          title: 'Waitlist / contact',
          body: 'Use this card for a form, email capture, or direct contact route while the public release is still limited.',
          action: 'Add waitlist link',
          href: '#replace-waitlist-link',
          placeholder: true,
        },
      ],
      statusTitle: 'Assets you still need to replace',
      statusBody:
        'Demo video URL, install package/store URL, X link, GitHub link, and contact destination are intentionally left as obvious placeholders.',
    },
    footer: {
  ...
  zh: {
    ...
    demo: {
      ...
      body: '',
      noteKicker: '推荐嵌入方式',
      noteBody: '建议放一段简短流程演示：输入请求、看到推荐、确认路线、再到最终执行反馈。',
      placeholderLabel: '演示视频占位区',
      placeholderHint: '替换为公开 Demo 链接',
    },
    differences: {
      eyebrow: '差异点',
      title: '',
    ...
    trySection: {
      ...
      cards: [
        {
          title: 'Demo 构建版本',
          body: '这里可以放给评委或技术用户使用的测试构建、源码说明或临时体验入口。',
          action: '补充 demo build 链接',
          href: '#replace-demo-build-link',
          placeholder: true,
        },
        {
          title: '安装扩展',
          body: '这里接入你后续的安装包、商店地址或安装文档，页面结构已经为它预留好。',
          action: '补充安装链接',
          href: '#replace-install-link',
          placeholder: true,
        },
        {
          title: '等待列表 / 联系方式',
          body: '如果还没完全开放，这张卡片可以承接表单、邮箱收集或者直接联系入口。',
          action: '补充等待列表链接',
          href: '#replace-waitlist-link',
          placeholder: true,
        },
      ],
      statusTitle: '你还需要替换的内容',
      statusBody:
        'Demo 视频链接、安装包或商店链接、X 链接、GitHub 链接和联系地址目前都保留成了明显占位。',
    },
    footer: {
